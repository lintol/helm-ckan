...
*/}}
{{- define "ckanProductionIniWithoutPlugins" -}}
    #
    ...
    beaker.session.secret = JXimikobnFN6nUCyqYFDoZVtf

    # `paster make-config` generates a unique value for this each time it generates
    # a config file.
    app_instance_uuid = 98f77cd2-dbbb-482b-be95-abd16c4ccf9e
    ...
    {{ if .Values.plugins.lintol }}
    # ckanext.validation.lintol_token = {{ .Values.plugins.lintol.token }}
    {{ end }}
